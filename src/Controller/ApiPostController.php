...
class ApiPostController extends AbstractController
{
    ...
    // Route blocked but keep it for the logic 
    ...
    // Route blocked but keep it for the logic 
    // /**
    //  * @Route("/api/post/2", name="api_post_index_2")
    //  */
    // public function postcodeToGeoloc(CallApiService $callApiService, PsAdressRepository $psAdressRepository  ): Response
    // {  

    //     $allPsCustomer = $psAdressRepository->findAll();
    //          foreach ($allPsCustomer as $value => $psCustomer )
    //          {
    //             if($psCustomer->getLatitude() === NULL){
    //                 $truePostCode = $psCustomer->getPostcode();
    //                // array_push($postcode, $psCustomer->getPostcode());
    //                 $apiResult = $callApiService->getFranceData($truePostCode);
    //                // array_push($apiResultArray, $apiResult);
